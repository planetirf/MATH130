...
* Getting data into R and exploring [[03_import]](03_import.html) 
    - **Before class** Go to the [Data](https://norcalbiostat.netlify.com/data/cleaned_data/) and download the following data sets: `Police Shootings`, `email`, and `NCBirths`. Put these in your `MATH130` folder. 
