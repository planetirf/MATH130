...
# Introduction
In this lab we will introduce ways to get data into R, how to use functions to perform tasks, and how to deal with categorical data.
...
### Data to download
* Go to the cleaned data section of the [datasets page](http://www.norcalbiostat.com/data/) and download the following data sets: `NCBirths`, `email`, and `parHIV`. 
...
3. Submit the **HTML** or **WORD** file via BBLearn before the due date.
