...
Any other data sets require instructor approval. Data sets such as the 'plants' or arm strength' data sets are insufficiently complex for this project. Also you can't use the `email` or `NCbirths` data sets because we've used them too much already.
...
* Knit your file to HTML, WORD, or PDF, then upload to
  [here](https://drive.google.com/drive/folders/1PBoNjP3940K6JUvGE1674-nT3LgVFmK6?usp=sharing)
  by the due date.
* Put your student username in the name of the file somewhere, so that your fellow
  students know which assignment they are to reveiw.


# Peer Review

After the submission deadline, your analysis projects will be randomly assigned to two other projects to peer review and score.
This means you will score and provide feedback on 2 reports. The instructor(s) will also score all projects for their class sections.
...
* Your assignments will be posted on this [spreadsheet](https://docs.google.com/spreadsheets/d/1ik6HlN7LHSlxmqMF80Dn0p8wEpaOV-igPw0OB2AQb0k/edit?usp=sharing).
