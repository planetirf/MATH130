...
To allow for adequate time for peer grading the submission deadline is a strict cutoff. Really late assignments won't be accepted. Knit your file to HTML, then upload to [here](https://www.dropbox.com/request/S3KxRFTY7ZcHhZSRHaYT) by the due date. 
...
All submissions will be posted to the course website, go here and download the report to your computer. Either by using the comment and editing feature in Adobe, or by turning on track changes in WORD, provide comments directly into the document itself. 

### Submitting the review
Upload your review to BBLearn by the due date. Then go record your scores in a [Google Form](https://goo.gl/forms/7I4zsYpSsiZpgKyH3).  This data will be downloaded, cleaned and processed (all using R of course) by the instructor to generate your project grade. 
