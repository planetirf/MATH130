---
title: 'Controlling your factors'
output:
  html_document:
    highlight: tango
    theme: yeti
...
We need to take control of these factors! We can do that by specifying the `levels` of the factor.

```{r}
levels(email$number) <- c("none", "small", "big")
table(email$number)
```
