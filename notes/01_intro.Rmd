...
output: 
  slidy_presentation: 
    theme: yeti
    highlight: tango
    footer: "rdonatello@csuchico.edu"
---
...
* Data Science Initiative 
    ...
    - Community coding - drop in hours held in the library. Spring 19 hours TBD
...
* Googling error messages: https://www.google.com/search?q=common+R+error+messages
    - Good blog by expert R contributer http://varianceexplained.org/courses/errors/ 
...
## Getting Help -- I'm a book kinda person
