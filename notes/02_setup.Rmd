---
title: "Lesson 02 - Getting ready to start"
...
You will put all files related to this class in here. For example lecture notes go in the document folder, 
homework in the `homework` folder, and data in, you guessed it, the `data` folder. 
...
Click [[this link]](hw/hw1.Rmd) to download Homework 1 assignment and put it in your `homework` folder now.  
...
We'll get into how R sees and uses data in the next lesson. 
